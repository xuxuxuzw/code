              ...
              <div class="dashboard">
                <div class="dashboard-workplace-header-extra">
                  <Row type="flex" justify="center" align="middle" :gutter="12">
                    <Col span="8">
                      <p>
                        <Avatar icon="md-apps" size="small" style="color: #40a9ff;background-color: #e6f7ff"/>
                        <span>剩余条数</span>
                      </p>
                      <p>
                    ...
                    <Col span="8">
                      <p>
                        <Avatar icon="md-checkbox-outline" size="small" style="color: #ffa940;background-color: #fff7e6"/>
                        <span>已发送</span>
                      </p>
                      <p>
                    ...
                    <Col span="8">
                      <p>
                        <Avatar icon="md-clipboard" size="small" style="color: #73d13d;background-color: #f6ffed"/>
                        <span>总条数</span>
                      </p>
                      <p>
